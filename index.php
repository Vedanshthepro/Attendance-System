...
<div class="container" id="signin">
    ...
    <form method="post" action="">
     ...
     <div class="student-login">
        ...
        <button onclick="window.location.href='studentLogin.php'" class="btn-student">Student Login</button>
     </div>
   </div> 
   <script>
...
if($userType == "Administrator"){
      ...
      $query = "SELECT * FROM tblstudents WHERE email = '$email' and registrationNumber='$password'"; 
      ...
      if($num > 0){
        ...
        $message = " Invalid Email/Registration Number!";
        echo "<script>showMessage('" . $message . "');</script>";
